        ...
        <section className="py-24 px-4 sm:px-6 border-t border-border/50">
            <div className="max-w-6xl mx-auto">
                ...
                <div className="text-center mb-14">
                    ...
                    >
                        Every feature is intentional — built to keep you focused on writing,
                        not configuration.
                    </motion.p>
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
                    {FEATURES.map((f, i) => (
                        ...
                        >
                            <div
                                className={`w-10 h-10 rounded-xl ${f.bg} flex items-center justify-center mb-4 group-hover:scale-105 transition-transform`}
                            >
